...
import editFood from "../../assets/images/editFood.png";
    ...
    <div className="flex justify-center bg-[#a4bdba] font-helvetica ">
      <div className="flex justify-center items-center flex-1">
        ...
        <form className="flex flex-col bg-[#e8d7b1] w-6/12 gap-y-2 p-6 my-2 rounded-3xl border-white border-8">
          ...
          <div className="flex justify-around bg-slate-950/10 rounded-2xl border-slate-950/10 border-2 py-2">
            <button
              className="btn-save"
              onClick={(event) => {
