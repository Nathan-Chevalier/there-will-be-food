...
import viewPantry from "../../assets/images/viewPantry.png";
...
export const PantryList = ({ currentUser }) => {
  ...
  return (
    <div className="flex flex-col bg-[#995e40] pb-6 mt-2 pt-2 px-6 rounded-3xl">
      <div className="flex justify-between pt-2">
        ...
        <div className="pb-2">
          <img src={viewPantry} alt="View All" />
        </div>
      </div>
