...
import viewRefrigerator from "../../assets/images/viewRefrigerator.png";
...
export const FridgeList = ({ currentUser }) => {
  ...
  return (
    <div className="flex flex-col bg-[#274857] pt-2 px-6 pb-6 mt-2 rounded-3xl">
      <div className="flex justify-between pt-2">
        ...
        <div className="pb-2 pr-6">
          <img src={viewRefrigerator} alt="View All" />
        </div>
      </div>
      <div className="flex flex-row flex-wrap justify-around items-start gap-y-5 py-5 bg-[#b2c7c8] border-white border-8 rounded-3xl">
